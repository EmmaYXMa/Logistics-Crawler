...
def lease_spider(max_pages):
    ...
    while page <= max_pages:
        url = 'http://lf.58.com/cangkucf/pn' + str(page)
...
def get_single_item_data(item_url):
    ...
    f = open('58lease_warehouse_info_lf.txt','a')
    ...
    h,r,w ={}, file('58lease_warehouse_info_lf.txt'), file('58lease_warehouse_info_after_removral_lf.txt','w')
