...
def lease_spider(provience,max_pages):
    ...
    for link in soup.findAll('div', {'class':'index_bo'}:

    page = 2
    while page <= max_pages:
        url = 'http://tj.58.com/cangkucf/pn' + str(page)
...
def get_single_item_data(item_url):
    ...
    f = open('58lease_warehouse_info_tj.txt','a')
    ...
    h,r,w ={}, file('58lease_warehouse_info_tj.txt'), file('58lease_warehouse_info_after_removral_tj.txt','w')
